  ...
  Future<void> _submit(PlantModel original) async {
    ...
    if (success) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Hooray! Tanaman berhasil diperbarui. 🌿')),
      );
          ...
          body: plant == null
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  // ── Preview Gambar dengan Cache Busting ──
                  GestureDetector(
                          ...
                          children: [
                            _hasNewImage
                              ...
                              fit: BoxFit.cover,
                                ...
                                : Image.network(
                              // Tambahkan timestamp agar gambar lama langsung terganti
                              "${plant.gambar}?v=${DateTime.now().millisecondsSinceEpoch}",
                              fit: BoxFit.cover,
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                padding: const EdgeInsets.symmetric(
                                    vertical: 8),
                                child: const Text(
                                  'Ketuk untuk ganti gambar tanaman',
    ...
    return TextFormField(
      ...
      validator: (value) {
        if (value == null || value.trim().isEmpty) {
          return '$label tidak boleh kosong ya.';
        }
        return null;
      },
    );
