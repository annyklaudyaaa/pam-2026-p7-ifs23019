...
class BottomNavWidget extends StatelessWidget {
  ...
  static const List<_NavItem> _items = [
    ...
    // --- MENU DESSERTS DITAMBAHKAN DI SINI ---
    _NavItem(
      label: 'Desserts',
      route: RouteConstants.desserts,
  ...
  // --- UPDATE LOGIK INDEX DI SINI ---
  int _getSelectedIndex(String location) {
    if (location == RouteConstants.home) return 0;
    if (location.startsWith(RouteConstants.plants)) return 1;
    if (location.startsWith(RouteConstants.desserts)) return 2; // Index baru
    if (location.startsWith(RouteConstants.profile)) return 3; // Profile jadi index 3
    return 0;
  }
}
