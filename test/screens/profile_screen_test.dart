...
import 'package:pam_p7_2026_ifs23019/features/profile/profile_screen.dart';
...
void main() {
  group('ProfileScreen', () {
    ...
    testWidgets('menampilkan nama pengguna', (tester) async {
      ...
      expect(find.text('Anny Klaudya'), findsOneWidget);
    });
    ...
    testWidgets('menampilkan username', (tester) async {
      ...
      expect(find.text('ifs23019'), findsOneWidget);
    });
